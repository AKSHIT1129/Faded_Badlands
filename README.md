...
**Faded Badlands** is a solo-developed open-world game focused on environment design and atmospheric storytelling. Inspired by the narrative and setting of *Red Dead Redemption 2*, this project serves as a practical application of game design, physics, and programming concepts. It features a concentrated map designed to showcase fundamental open-world mechanics and environmental traversal.
